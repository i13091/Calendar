...

{
    public class AppSettings : INotifyPropertyChanged
    {
        ...
        public AppSettings()
        {
            ...
            if (appData.Values.ContainsKey("IsPaintBtn"))
                this.IsPaintBtn = (bool)appData.Values["IsPaintBtn"];


            /*** 
             * <<<カラーの設定方法を変更：2016/09/06 >>>
             * ColorではなくSelectedColorとして登録
             */
            ...
            */
            ...
            if (appData.Values.ContainsKey("SelectedColor"))
                this.SelectedColor = (Color)appData.Values["SelectedColor"];
        ...
        public bool IsPaintBtn
        {
            set { SetProperty<bool>(ref isPaintBtn, value); }
            get { return isPaintBtn; }
        }
        public void Save()
        {
            ApplicationDataContainer appData = ApplicationData.Current.LocalSettings;
            ...
            */
            appData.Values.Add("SelectedColor", this.SelectedColor);
            appData.Values.Add("Thickness", this.Thickness);
            appData.Values.Add("IsPaintBtn", this.IsPaintBtn);
        }
